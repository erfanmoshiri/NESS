...
In the first part, we discuss graph learning with self-supervised methods. We then discuss handling missing information in graphs through imputation and learning under missingness.
