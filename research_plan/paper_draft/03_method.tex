...
used by the classification head and all objectives. The view-generation method is itself a modular choice; we experiment with several options in Section~\ref{sec:experiments} and adopt edge-masking as the best setting for our problem.
